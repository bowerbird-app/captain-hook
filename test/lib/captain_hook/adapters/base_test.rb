  ...
  module Adapters
    class BaseTest < Minitest::Test
      ...
      def test_verify_signature_returns_true_by_default
        ...
        assert result, "Base adapter should accept all signatures"
      end

      def test_extract_timestamp_returns_nil_by_default
        result = @adapter.extract_timestamp({})
        assert_nil result, "Base adapter should return nil for timestamp"
      end
